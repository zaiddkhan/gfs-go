...
func Call(srv gfsgo.ServerAddress, rpcname string, args interface{}, reply interface{}) error {
...
func CallAll(dst []gfsgo.ServerAddress, rpcname string, args interface{}) error {
	ch := make(chan error)
	for _, d := range dst {
